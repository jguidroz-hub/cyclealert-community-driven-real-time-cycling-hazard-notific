  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="CycleAlert - Community-driven real-time cycling hazard notification platform-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
