...
const FROM = process.env.EMAIL_FROM || 'CycleAlert - Community-driven real-time cycling hazard notification platform <noreply@example.com>';
const APP_NAME = 'CycleAlert - Community-driven real-time cycling hazard notification platform';
